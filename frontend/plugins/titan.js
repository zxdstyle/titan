...
import { Input as ur } from "@nextui-org/react";
var H = { exports: {} }, j = {};
/**
 * @license React
...
function sr() {
  if (Re)
    return j;
  Re = 1;
  var D = Ce, P = Symbol.for("react.element"), V = Symbol.for("react.fragment"), y = Object.prototype.hasOwnProperty, F = D.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, A = { key: !0, ref: !0, __self: !0, __source: !0 };
  function S(E, l, R) {
...
function fr() {
  return Te || (Te = 1, process.env.NODE_ENV !== "production" && function() {
    var D = Ce, P = Symbol.for("react.element"), V = Symbol.for("react.portal"), y = Symbol.for("react.fragment"), F = Symbol.for("react.strict_mode"), A = Symbol.for("react.profiler"), S = Symbol.for("react.provider"), E = Symbol.for("react.context"), l = Symbol.for("react.forward_ref"), R = Symbol.for("react.suspense"), v = Symbol.for("react.suspense_list"), g = Symbol.for("react.memo"), m = Symbol.for("react.lazy"), I = Symbol.for("react.offscreen"), X = Symbol.iterator, Pe = "@@iterator";
    function Se(e) {
    ...
    function Ae(e) {
      return !!(typeof e == "string" || typeof e == "function" || e === y || e === A || Fe || e === F || e === R || e === v || De || e === I || xe || je || ke || typeof e == "object" && e !== null && (e.$$typeof === m || e.$$typeof === g || e.$$typeof === S || e.$$typeof === E || e.$$typeof === l || // This needs to include all possible module reference object
    ...
    var _ = Object.assign, w = 0, ee, re, te, ne, ae, ie, oe;
    function ue() {
    }
...
` + a[s].replace(" at new ", " at ");
    ...
    function ze(e, r) {
      if (typeof e.ref == "string" && x.current && r && x.current.stateNode !== r) {
        var t = b(x.current.type);
        J[t] || (c('Component "%s" contains the string ref "%s". Support for string refs will be removed in a future major release. This case cannot be automatically converted to an arrow function. We ask you to manually fix this case by using useRef() or createRef() instead. Learn more about using refs safely here: https://reactjs.org/link/strict-mode-string-ref', b(x.current.type), e.ref), J[t] = !0);
      }
    }
    function Ke(e, r) {
      {
    ...
    function Ze(e, r, t, n, o) {
      {
        ...
        t !== void 0 && (de(t), a = "" + t), Ge(r) && (de(r.key), a = "" + r.key), Je(r) && (d = r.ref, ze(r, o));
        for (u in r)
...
var Oe = H.exports;
function dr({ children: D }) {
  return /* @__PURE__ */ Oe.jsx("div", { children: /* @__PURE__ */ Oe.jsx(ur, {}) });
}
export {
  dr as default
};
